window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function countSummary(group, t) {
			return [group.reasoningCount > 0 ? t("count.thoughts", { count: group.reasoningCount }) : "", group.toolCount > 0 ? t("count.toolCalls", { count: group.toolCount }) : ""].filter(Boolean).join(" · ");
		}
